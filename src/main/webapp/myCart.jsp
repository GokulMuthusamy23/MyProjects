...
%>
        ...
        <thead>
          ...
          <th scope="col">S.No</th>
            ...
            <th scope="col">Remove <i class='fa fa-trash-alt'></i></th>
          </tr>
        </thead>
        <tbody>
      <%
      ...
      %>
          <tr>
           ...
           <td><%out.println(sno);%></td>
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=inc"><i class='fa fa-plus-circle'></i></a> <%=rs.getString(8)%> <a href="incDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=dec"><i class='fa fa-minus-circle'></i></a></td>
